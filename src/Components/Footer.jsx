    ...
    <div className='d-flex flex-column justify-content-center align-items-center w-100'>
       <div  style={{backgroundColor:"#f1f0f4"}} className='w-100 d-flex justify-content-center align-items-center'>
            <div className='w-75 d-flex justify-content-center align-items-center pt-3 pb-3'>
                ...
                <img width={'380px'} style={{height:"90px"}} src="https://media-assets.swiggy.com/swiggy/image/upload/fl_lossy,f_auto,q_auto/portal/m/app_store.png" alt="" />
            </div>
       </div>
       <div style={{backgroundColor:"#02050c"}} className='d-flex justify-content-center align-tems-center w-100'>
            <div className='w-75 d-flex justify-content-around  pt-5 pb-5'>
                <div>
                    <div className='d-flex align-items-center'><img width={'60px'} src={logo} alt="Logo" />
                    <h3 style={{color:"white"}} className='fw-bolder mt-1 ms-2'>HOTEL AHANA</h3></div>
                    <p style={{color:"white"}}>Brahmavara, Near Little Rock School</p>
                </div>
